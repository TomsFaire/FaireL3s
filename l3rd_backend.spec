# PyInstaller spec for standalone backend (no macOS .app BUNDLE).
# Used by the Electrobun build: produces dist/FaireL3s/ folder with executable + _internal/.
# Build: pyinstaller l3rd_backend.spec
